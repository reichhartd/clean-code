...
assert(FilePath("log/cups/access_log").get_filename() == "access_log")
assert(FilePath("log/cups/").get_filename() == "")
assert(FilePath("cups/access_log").get_filename() == "access_log")
assert(FilePath("access_log").get_filename() == "access_log")
